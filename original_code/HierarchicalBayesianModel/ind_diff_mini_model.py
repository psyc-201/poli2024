...
# Get unique subject numbers from our filtered data
unique_subjects = np.unique(markasgood.values.reshape(-1))
n_subjects = len(unique_subjects)

posterior = pd.DataFrame()
posterior["subjnum"] = unique_subjects
...
print(f"Results saved to gen_summary_rep.csv and posterior_median_rep.csv")
