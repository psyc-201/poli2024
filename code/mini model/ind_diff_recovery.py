...
# PARAMETER RECOVERY: Load simulated data instead of original here!
data = pd.read_csv("sim_data.csv", sep=",")
...
markasgood = pd.read_csv("../original model/markasgood.csv", sep=",", header=None)
# Import markasgood smiley data
markasgood_s = pd.read_csv("../original model/markasgood_smiley.csv", sep=",", header=None)
# concatenate them
...
if useADVI:
    ...
    plt.savefig("plots/advi_convergence_sim.png", dpi=150, bbox_inches='tight')
    plt.close()  # Close instead of show to avoid blocking

# Model goodness of fit
# WAIC/LOO commented out - not compatible with ADVI
...
plt.savefig("plots/forest2_lambda0_sim.png")
plt.show()

az.plot_trace(trace, var_names=["mu_LT0", "mu_LT1"])
plt.savefig("plots/mu_LT_sim.png")
plt.show()

az.plot_trace(trace, var_names=["mu_SL0", "mu_SL1"])
plt.savefig("plots/mu_SL_sim.png")
plt.show()

az.plot_trace(trace, var_names=["kappa", "theta", "mu_LA"])
plt.savefig("plots/hyper_LA_sim.png")
plt.show()
...
summary.to_csv("gen_summary_sim.csv")
...
# ...and save them
posterior.to_csv("posterior_median_sim.csv")