...
data = pd.read_csv("../original model/Roris_nostd.csv", sep=",")
# Import smiley data
data_s = pd.read_csv("../original model/Roris_smiley.csv", sep=",")
...
if useADVI:
    ...
    plt.savefig("plots/advi_convergence.png", dpi=150, bbox_inches='tight')
...
summary.to_csv("gen_summary_reproduction.csv")
